...
export class AppComponent implements AfterViewInit {
  ...
  showConnectOnClick() {
    ...
    this.jsPlumbInstance.registerConnectionType("basic", this.basicType);

    // this is the paint style for the connecting lines..


    //this.jsPlumbInstance.batch(this.batchExec);
    this.batchExec();
  ...
  batchExec() {
    ...
    this._addEndpoints("Window4", ["TopCenter", "BottomCenter"], ["LeftMiddle", "RightMiddle"]);
    this._addEndpoints("Window2", ["LeftMiddle", "BottomCenter"], ["TopCenter", "RightMiddle"]);
    this._addEndpoints("Window3", ["RightMiddle", "BottomCenter"], ["LeftMiddle", "TopCenter"]);
    this._addEndpoints("Window1", ["LeftMiddle", "RightMiddle"], ["TopCenter", "BottomCenter"]);
